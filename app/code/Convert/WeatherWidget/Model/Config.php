...
class Config
{
    const ENABLED_XML_PATH = 'convert_weather_widget/general/enabled';
    const OPENWEATHERMAP_API_KEY_XML_PATH = 'convert_weather_widget/general/openweathermap_api_key';
    const DEFAULT_CITY_XML_PATH = 'convert_weather_widget/general/default_city';
    const DEFAULT_COUNTRY_ID_XML_PATH = 'convert_weather_widget/general/default_country_id';
