...
class PostBlockActions extends Column
{
    private const ENTITY_NAME = 'Post';
    private const EDIT_URL_PATH = 'convert_blog/post/edit';
    private const DELETE_URL_PATH = 'convert_blog/post/delete';
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[PostInterface::POST_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = [PostInterface::POST_ID => $item[PostInterface::POST_ID]];
